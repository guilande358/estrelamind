...
CREATE TABLE public.profiles (
  ...
  display_name TEXT,
  avatar_url TEXT,
  mode TEXT DEFAULT 'profissional' CHECK (mode IN ('profissional', 'estudante', 'familia')),
...
CREATE TABLE public.expenses (
  ...
  category TEXT DEFAULT 'outros' CHECK (category IN ('casa', 'filhos', 'transporte', 'estudos', 'lazer', 'alimentacao', 'saude', 'outros')),
